...
<!--
Source references:
- https://github.com/expo/skills (plugins/expo/skills/building-native-ui/SKILL.md)
- https://github.com/expo/skills (plugins/expo/skills/building-native-ui/references/tabs.md)
- https://github.com/expo/skills (plugins/expo/skills/building-native-ui/references/animations.md)
- https://docs.expo.dev/ui-programming/image/
-->
